...
public class GlobalExceptionHandler {
    ...
    private Map<String, Object> handleDataIntegrityViolation(DataIntegrityViolationException e, HttpServletRequest request) {
    ...
    public Map<String, Object> handleQueryTimeoutException(QueryTimeoutException e, HttpServletRequest request) {
    ...
    public Map<String, Object> handlePersistenceException(PersistenceException e, HttpServletRequest request) {
